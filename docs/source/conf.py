#
# Sphinx configuration for aiida-amber
#
...
release = aiida_amber.__version__
...
html_theme = "furo"
html_logo = "images/amber-BioSimDB-logo.png"
...
html_use_opensearch = "https://aiida-amber.readthedocs.io"
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, "aiida_amber")
