...
def launch(params):
    ...
    inputs["input_file"] = SinglefileData(file=os.path.join(os.getcwd(), params.pop("i")))

    if "cf" in params:
        inputs["charge_file"] = SinglefileData(file=os.path.join(os.getcwd(), params.pop("cf")))
    if "a" in params:
        inputs["additional_file"] = SinglefileData(file=os.path.join(os.getcwd(), params.pop("a")))
    if "rf" in params:
        inputs["res_top_file"] = SinglefileData(file=os.path.join(os.getcwd(), params.pop("rf")))
    if "ch" in params:
        inputs["check_file"] = SinglefileData(file=os.path.join(os.getcwd(), params.pop("ch")))
    if "ge" in params:
        inputs["esp_file"] = SinglefileData(file=os.path.join(os.getcwd(), params.pop("ge")))
